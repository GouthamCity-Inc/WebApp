...
|---------------------------|------------------------------------------------------------------------------------------------------------------|
| Cloud Storage             | cloud storage bucket is used to house the assignment submission ZIP file, organized by user.id and submission.id |
...
| **GCP Service** | **Description**                                                                                                  |
|---------------------------|------------------------------------------------------------------------------------------------------------------|
| IAM             | service account is used to authorize lambda runtime to perform necessary actions to Cloud Storage bucket for adding a ZIP for given submission |
